...
配对显著性（每模拟 Δ = ASR − CE；配对 t + Wilcoxon，n=90）:
  空间CV AUC      Δ+0.0038±0.0045  t=+7.96  p<0.0001  Wilcoxon p<0.0001
  空间CV Brier    Δ-0.0012±0.0013  t=-9.13  p<0.0001  Wilcoxon p<0.0001
  空间CV LogLoss  Δ-0.0028±0.0029  t=-9.21  p<0.0001  Wilcoxon p<0.0001
  测试集 Iso ratio Δ-0.0841±0.0614  t=-12.99  p<0.0001  Wilcoxon p<0.0001
------------------------------------------------------------------
